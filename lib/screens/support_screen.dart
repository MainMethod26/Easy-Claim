...
class _SupportScreenState extends State<SupportScreen> {
  ...
  void _openChatWithAgent(
    ...
    showModalBottomSheet(
      ...
      backgroundColor: Colors.transparent,
      builder: (context) => _AgentChatModal(agent: agent, cover: cover),
    );
  }
}
...
class _AgentChatModalState extends State<_AgentChatModal> {
  ...
  void initState() {
    ...
    _messages.add({
      'fromAgent': true,
      'text':
          'Hello Thabo! I am ${widget.agent.name}, your claims assessor for ${widget.cover.underwriter}. I have your active policy (${widget.cover.policyNumber}) open for ${widget.cover.assetName}. How can I assist you right now?',
      'time': 'Just now',
    });
  }
  ...
  String _generateAssessorResponse(String userText) {
    ...
    if (lower.contains('status') || lower.contains('stage')) {
      return 'Your claim for ${widget.cover.assetName} is verified and currently progressing through our automated Fast Lane review. All criteria have passed!';
      ...
      return 'Thank you for reaching out, Thabo. I have noted this on your policy docket (${widget.cover.policyNumber}). Is there anything else you need assistance with?';
    }
  }
