...
class _AuthScreenState extends State<AuthScreen> {
  ...
  // Controllers
  final _emailController = TextEditingController(text: 'thabo@easyclaim.co.za');
  final _passwordController = TextEditingController(text: '••••••••');
  final _nameController = TextEditingController(text: 'Thabo Mokoena');
  final _idNumberController = TextEditingController(text: '9408125089086');
  final _phoneController = TextEditingController(text: '+27 82 456 7890');
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: const AwesomeSnackbarContent(
          ...
          message: 'Authenticated securely on EasyClaim network.',
  ...
  void _handleRegister() {
    if (!_agreeTerms) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please accept the data consent terms to proceed.'),
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: const AwesomeSnackbarContent(
          ...
          message: 'Welcome to EasyClaim! Setting up your claim vault...',
          contentType: ContentType.success,
        ),
      ),
    );
              ...
              children: [
                ...
                Center(
                  child: TextButton.icon(
                    ...
                    label: const Text(
                      'Quick Demo Access (Skip as Thabo)',
                      style: TextStyle(
                        color: Color(0xFF0F172A),
                        fontWeight: FontWeight.w700,
                        fontSize: 14.0,
