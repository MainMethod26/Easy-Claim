                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                (AuthService.currentUserName ?? 'User').toUpperCase(),
                      ...
                      ActiveClaimCard(
                        ...
                        claimant: primaryClaim?.claimant ?? AuthService.currentUserName ?? 'User',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          const Text(
            'Automated review clock is running: Estimated decision under 4 hours.',
            style: TextStyle(color: Color(0xFF64748B), fontSize: 13),
          ),
          const SizedBox(height: 12),
          const Divider(color: Color(0xFFE2E8F0), height: 1),
